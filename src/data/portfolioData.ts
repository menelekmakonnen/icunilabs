...
export const portfolioProjects: ProjectData[] = [
    ...
    },
    {
        ...
        tags: ['React', 'Data Alignment', 'Corporate Solutions'],
        icon: Database,
    ...
    },
    {
        ...
        tags: ['React', 'Vite', 'TypeScript', 'Corporate Solutions'],
        icon: LayoutTemplate,
    ...
    },
    {
        ...
        tags: ['React', 'Data Visualization', 'Privacy'],
        icon: LineChart,
    ...
    },
    {
        ...
        tags: ['React', 'Corporate Solutions', 'Talent Directory'],
        icon: Users,
    ...
    },
    {
        ...
        tags: ['React', 'Interactive Scheduling', 'Logistics'],
        icon: Server,
    ...
    },
    {
        ...
        tags: ['React', 'AI Collaboration', 'Corporate Solutions'],
        icon: Terminal,
    ...
    },
    {
        ...
        tags: ['React', 'Asset Management', 'Media Solutions'],
        icon: Aperture,
    ...
    },
    {
        ...
        tags: ['React', 'Node.js', 'Information Architecture'],
        icon: Book,
    ...
    },
    {
        ...
        tags: ['React', 'Community Portal', 'HTML'],
        icon: PlayCircle,
