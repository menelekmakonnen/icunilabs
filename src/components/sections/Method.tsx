    ...
    return (
        <section id="method" className="py-24 md:py-32 border-t border-neutral-900 relative bg-neutral-950/90 backdrop-blur-md z-10">
            <div className="max-w-6xl mx-auto px-6" ref={containerRef}>
                ...
                <motion.div
                    className="bg-neutral-900/40 border border-neutral-800 p-8 md:p-12 rounded-[2rem] max-w-4xl mx-auto shadow-2xl relative overflow-hidden"
                            ...
                            {[
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-neutral-500 leading-relaxed md:max-w-[160px] mx-auto font-medium">
                                            {step.desc}
                                        </p>
                                    </div>
                                </motion.div>
